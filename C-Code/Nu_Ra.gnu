...
set raxis
set key title ""
set key inside left bottom vertical Right noreverse enhanced autotitles nobox
...
set xrange [ * : 2e14 ] noreverse nowriteback
...
set loadpath "/home/stevie/.ownCloud/Templates/Gnuplot" 
set fontpath 
set psdir
...
load '/home/stevie/ownCloud/Templates/Gnuplot/beauty.gnu'

set xlabel "Ra"
set ylabel "q_{real}/q_{lin}"
...
set ylabel '{Nu/Ra^{1/3}}'
p 'q.csv' u 2:($4*($2**(-0.3333))) title "Nu_m,Ra_m" w p ls 1,\
'' u 2:(($4*$6/$7)*$2**(-0.3333)) title "Nu_r,Ra_m" w p ls 2,\
'' u 3:($5*$3**(-0.3333)) title "Nu_c,Ra_c" w p ls 3,\
'' u 3:(($5*$8/$7)*$3**(-0.3333)) title "Nu_r,Ra_c" w p ls 4,\
